        ...
        {data.length ? (
          <div className="h-[220px]"><ResponsiveContainer>
            <AreaChart data={data} margin={{ left: 0, right: 8, top: 8, bottom: 0 }}>
              ...
              <YAxis axisLine={false} tickLine={false} tickMargin={12} width={48} domain={[0, 100]} tickFormatter={(v) => Number(v).toFixed(0)} />
              <Tooltip cursor={{ stroke: "var(--border)", strokeDasharray: "4 4" }} contentStyle={ts} formatter={(v) => [Number(v).toFixed(2), "平均分"]} />
        ...
        {data.length ? (
          <div className="h-[220px]"><ResponsiveContainer>
            <LineChart data={data} margin={{ left: 0, right: 8, top: 8, bottom: 0 }}>
              ...
              <YAxis axisLine={false} tickLine={false} tickMargin={12} width={48} domain={[0, 100]} tickFormatter={(v) => Number(v).toFixed(0)} />
              <Tooltip cursor={{ stroke: "var(--border)", strokeDasharray: "4 4" }} contentStyle={ts} formatter={(v) => [Number(v).toFixed(2), "质量分"]} />
